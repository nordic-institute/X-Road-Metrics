...
MODULE = "collector"
APPDIR = "/srv/app"
# X-Road instance (ee-dev, ee-test, EE)
INSTANCE = "sample"
...
# 1 month = max 31 days = 2678400 seconds
# 3 months = max 92 days = 7948800 seconds
# 1 year = 365 days = 31536000 seconds
RECORDS_FROM_OFFSET = 31536000
