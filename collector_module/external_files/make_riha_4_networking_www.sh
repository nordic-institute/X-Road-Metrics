#!/bin/bash
#
# Usage: make_riha_4_networking_www.sh
#
...
# Output file: riha_4_networking_www.json, hardcoded into ./subsystems_json_riha_4_networking_www.py
#
INPUT_RIHA="./riha_systems.json"
OUTPUT_RIHA="./riha_4_networking_www.json"
...
# Do the job
python3 ./subsystems_json_riha_4_networking_www.py -s ${SECURITY_SERVER_URL} --riha ${INPUT_RIHA} # && \
# python3 ./subsystems_json_riha_4_networking_www.py -c ${CENTRAL_SERVER} --riha ${INPUT_RIHA} # && \
