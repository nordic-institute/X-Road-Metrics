...
DEFAULT_TIMEOUT = 5.0
REPORT_FILE = 'riha_4_networking_www.json'
STATUS_PRIORITY = {
    'IN_USE': 1,
    'ESTABLISHING': 2,
    'FINISHED': 3,
...
if __name__ == '__main__':
    ...
    if jsonData:
        for item in jsonData['content']:
            ...
            ownerCode = ''
            ownerName = ''
            # contacts = [] # Contacts MUST be NOT available for Networking scripts and files
            if 'details' in item:
                ...
                # Contacts MUST be NOT available for Networking scripts and files
            ...
            val = {'systemName': systemName, 'ownerName': ownerName, 
                   'status': systemStatus}
